...
<body>
	...
	<form name="formUpdate" method="post" action="" class="formulaire" enctype="multipart/form-data">
		<h2 align="center"><b>Mettre a Jour Des Informations...</b></h2>
		...
		<input type="text" name="TXTCIN" class="zonetext" value="<?php echo $_GET['mod']?>" readonly style="margin: 20px;background-color:white;color: #003;padding: 14px 20px;margin: 8px 0 ;border: none;cursor: pointer;width: 10%;text-align: center;border-radius: 10px;">
		...
		<input type="gmail" name="TXTADRESSE" class="zonetext" placeholder="Entrer Le ADRESSE ici ..."  style="margin: 20px;background-color:white;color: #003;padding: 14px 20px;margin: 8px 0 ;border: none;cursor: pointer;width: 55%;text-align: center;border-radius: 10px;"><br>
		<label><b>PHOTO : </b></label>
		<input type="file" style="margin: 20px;background-color:white;color: #514F4F;padding: 14px 20px;margin: 8px 0 ;border: none;cursor: pointer;width: 50%;" name="txtphoto" placeholder="Choisir une PHOTO ..." required>
		<input type="submit" style="background-color:#514F4F;color: white;padding: 14px 20px;margin: 8px 0 ;border: none;cursor: pointer;width: 50%; font-weight: bold;" name="btmod" value="Mettre a Jour">
		<p><a href="accuiel.php" style="background-color:#514F4F;color: white;padding: 14px 20px;margin: 8px 0 ;border: none;cursor: pointer;width: 50%; font-weight: bold;"> Tableau de Bord </a></p>
		...
		<?php
	     if(isset($_POST['btmod']))
		 {
			 ...
			 $reqUp="UPDATE personne SET NOM_PERSONNE='$NOM',PRENOM_PERSONNE='$PRENOM',PHOTO_PERSONNE='$traget',TRAVAIL_PERSONNE='$TRAVAIL',SALAIRE_PERSONNE='$SALAIRE',VILLE_PERSONNE='$VILLE',GMAIL_PERSONNE='$GMAIL',
			 STATUT_PERSONNE='$STATUT',LIEU_NAISSANCE='$LIEU',DATE_NAISSANCE='$DATE',
			 TEL_PERSONNE='$TEL',COMPTE_FINANCIER='$COMPTE',
			 ADRESSE_PERSONNE='$ADRESSE',PASSWORD_PERSONNE='$PASSWORD'
			 WHERE CIN_PERSONNE='$modifier'";
			 ...
			 if($resultat)
			 {
				 ...
				 echo "Echec de modification des  Donnees Valides";
